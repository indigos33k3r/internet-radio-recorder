 ...
 *
 * raspi: $ gcc -shared -fPIC -o msleep.so -I/usr/include/lua5.1 -llua5.1 msleep.c
 *
 * -I and -l may vary on your computer.
 * Your computer may use something besides -fPIC
 *
 * OSX, lion, macports lua: $ gcc -shared -fPIC -o msleep.so -I/opt/local/include -L/opt/local/lib -llua msleep.c
*/
